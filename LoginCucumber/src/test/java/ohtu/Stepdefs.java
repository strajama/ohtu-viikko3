...
public class Stepdefs {
    ...
    @When("^user can not login with incorrect password$")
    public void user_can_not_login_with_incorrect_password(String username, String password) throws Throwable {
        inputLines.add(username);
        inputLines.add(password);
    ...
    @When("^nonexistent user can not login to$")
    public void nonexistent_user_can_not_login_to(String username, String password) throws Throwable {
        inputLines.add(username);
        inputLines.add(password);
